 ...
 * generated in the com.knight.estoque.servico.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _ListarLivrosPaginacaoResponse_QNAME = new QName("http://servico.estoque.knight.com/", "listarLivrosPaginacaoResponse");
    private final static QName _ListarLivrosResponse_QNAME = new QName("http://servico.estoque.knight.com/", "listarLivrosResponse");
    private final static QName _ListarLivrosPaginacao_QNAME = new QName("http://servico.estoque.knight.com/", "listarLivrosPaginacao");
    private final static QName _ListarLivros_QNAME = new QName("http://servico.estoque.knight.com/", "listarLivros");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.knight.estoque.servico.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servico.estoque.knight.com/", name = "listarLivrosPaginacaoResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servico.estoque.knight.com/", name = "listarLivrosResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servico.estoque.knight.com/", name = "listarLivrosPaginacao")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servico.estoque.knight.com/", name = "listarLivros")
